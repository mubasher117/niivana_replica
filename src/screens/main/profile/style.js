...
const styles = StyleSheet.create({
  ...
  nameText: { fontSize: 18, color: "#19343A", fontWeight: "bold" },
  emailText: { fontSize: 16, color: "#19343A" },
  tilesContainer: { marginTop: "5%", marginBottom: "27%" },
  ...
  cardHeaderText: { fontSize: 16, color: "#19343A" },
  activeView: {
    height: 24,
    width: 60,
    borderRadius: 4,
    backgroundColor: "#5ECB9E",
    marginLeft: getWidthPercentage(2),
    alignItems: "center",
    justifyContent: "center"
  },
  cardDetailMain: {
