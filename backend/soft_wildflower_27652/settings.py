"""
Django settings for soft_wildflower_27652 project.
...
ROOT_URLCONF = "soft_wildflower_27652.urls"
...
WSGI_APPLICATION = "soft_wildflower_27652.wsgi.application"
...
cache_years = 10
max_age = cache_years * (365*24*60*60)
...
if USE_S3:
    ...
    AWS_S3_OBJECT_PARAMETERS = {"CacheControl": "max-age={}" .format(max_age)}
...
ZOOM_API_SECRET = env.str('ZOOM_API_SECRET', '')
